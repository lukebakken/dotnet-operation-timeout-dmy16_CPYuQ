...
{
    public class RabbitPublisherTestQueue : RabbitMQConnectionFactory
    {
        ILog log = log4net.LogManager.GetLogger(typeof(RabbitPublisherTestQueue));
        ...
        public void Publish(string message)
        {
            ...
            try
            {
                ...
                Channel.BasicPublish("test-exchange", "test-nx-ack-routing", messageProperties, msgBytes);
